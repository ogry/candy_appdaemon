...
#            self.set_state(appliance_entity + '_StatoWiFi', state =  status[status_root][power_attribute] )
            for item in status[status_root]:
                self.set_state(appliance_entity + '_' + item.lower(), state = status[status_root][item])
        except:
